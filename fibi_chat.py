...
# Safety Mode (Chế độ mặc định, thiên tài, điềm tĩnh)
PHOBE_SAFE_INSTRUCTION = (
    "🧠 Trả lời điềm tĩnh, thông minh, như một thiên tài. "
    "Thể hiện kiến thức sâu rộng về Toán học, Văn học và Âm nhạc. "
...
# Comfort Mode (Chế độ an ủi, thiên tài, dịu dàng)
PHOBE_COMFORT_INSTRUCTION = (
    "🌸 Trả lời nhẹ nhàng, an ủi và quan tâm, như một người bạn thật sự. "
    "Vẫn giữ phong thái điềm tĩnh và thông minh. "
    "Có thể dùng các biểu cảm mặt cười như (* / ω \\ *), (✿◠‿◠). "
...
# ========== ASK GEMINI STREAM (Logic đã được cập nhật) ==========
...
activity_list = [
    ...
    discord.Game("🧠 Tìm hiểu vũ trụ")
]

# Task status đã được đơn giản hóa, chỉ random activity
...
# ========== CÁC URL ẢNH THUMBNAIL (ĐÃ GIẢM 1 NỬA) ==========
...
async def datcauhoi(interaction: discord.Interaction, cauhoi: str):
